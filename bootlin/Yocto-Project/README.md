...
- [Images](#images)
  - [Giới thiệu về images](#giới-thiệu-về-images)
  - [Cấu trúc, biến của 1 image recipe](#cấu-trúc-biến-của-1-image-recipe)
  - [Ví dụ 1 image](#ví-dụ-1-image)
  - [Quá trình tạo root filesystem](#quá-trình-tạo-root-filesystem)
  - [Image types](#image-types)
  - [Package groups](#package-groups)
  - [Thực hành](#thực-hành-5)
- [Writing recipes - going further](#writing-recipes---going-further)
  - [The per-recipe sysroot](#the-per-recipe-sysroot)
  - [Using python code in metadata](#using-python-code-in-metadata)
  - [Variable flags - cờ của biến](#variable-flags---cờ-của-biến)
  - [Package features](#package-features)
  - [Condition features - tính năng có điều kiện](#condition-features---tính-năng-có-điều-kiện)
  - [Package splitting - cơ chế chia nhỏ gói của Yocto](#package-splitting---cơ-chế-chia-nhỏ-gói-của-yocto)
  - [Inspecting packages - kiểm tra gói](#inspecting-packages---kiểm-tra-gói)
  - [Chi tiết về dependencies](#chi-tiết-về-dependencies)
- [Licensing](#licensing)
- [The Yocto Project SDK](#the-yocto-project-sdk)
  - [Giới thiệu SDK](#giới-thiệu-sdk)
  - [SDK của Yocto project](#sdk-của-yocto-project)
  - [Các SDK đang có sẵn](#các-sdk-đang-có-sẵn)
  - [Thêm packages vào SDK](#thêm-packages-vào-sdk)
  - [Format của SDK](#format-của-sdk)
  - [Cách sử dụng SDK](#cách-sử-dụng-sdk)
  - [Các thành phần trong thư mục SDK sau khi cài - Ví dụ](#các-thành-phần-trong-thư-mục-sdk-sau-khi-cài---ví-dụ)
  - [Biến môi trường của SDK](#biến-môi-trường-của-sdk)
  - [Thực hành](#thực-hành-6)
- [Devtool](#devtool)
  - [Overview](#overview-1)
  - [Sử dụng devtool](#sử-dụng-devtool)
  - [Thực hành](#thực-hành-7)
- [Quản lý tự động các layer - Automating layer management](#quản-lý-tự-động-các-layer---automating-layer-management)
